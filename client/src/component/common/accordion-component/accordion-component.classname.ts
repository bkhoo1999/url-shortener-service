export enum AccordionComponentClass {
  ...
  ACCORDION_HEADER = "flex items-center justify-between w-full p-4 font-medium text-left text-gray-500 border border-gray-200 rounded-t-xl hover:bg-gray-100",
  ACCORDION_TITLE = "flex items-center",
  ACCORDION_TITLE_ICON = "w-6 h-6 shrink-0",
  ACCORDION_CONTENT = "p-5 border border-b-5 border-gray-200 rounded-b-xl",
